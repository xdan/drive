(function($){
	...
	var Drive = function () {
		...
		this.init = function(box) {
			...
			menu = $('<div class="xdsoft_context_menu xdsoft_shadow">'+
			...
			login = $('<div class="xdsoft_login">'+
					'<div class="xdsoft_login_form">'+
						...
						'<div><input type="button" class="go" value="Sign In"/></div>'+
					'</div>'+
				'</div>');
